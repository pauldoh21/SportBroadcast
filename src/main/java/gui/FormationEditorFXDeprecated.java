...
@Deprecated
public class FormationEditorFXDeprecated extends PanelNodeFX {
    PegButtonGroupManagerFX buttonGroupManager;

    public FormationEditorFXDeprecated(Formation formation) {
        super();
        ...
        FormationDisplayFXDeprecated formationDisplay = new FormationDisplayFXDeprecated(formation, buttonGroupManager, true);
