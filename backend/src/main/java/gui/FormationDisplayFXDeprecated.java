...
@Deprecated
public class FormationDisplayFXDeprecated extends PanelNodeFX {
    Formation formation;
    ...
    public FormationDisplayFXDeprecated(Formation formation, PegButtonGroupManagerFX buttonGroupManager, boolean interactable) {
        super();
        ...
        if (interactable) {
            for (PegButtonFX button : formationButtons) {
                if (button instanceof PegButtonSelectableFX selectableButton) {
                    selectableButton.setButtonGroupManager(buttonGroupManager);
